// ISO 3166-1 numeric → alpha-3 country codes.
// Used to match world-atlas topojson features (keyed on numeric id)
// to our internal alpha-3 country codes for the world map.
export const ISO_N3_TO_A3: Record<string, string> = {
