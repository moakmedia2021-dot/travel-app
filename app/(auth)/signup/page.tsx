...
// Google sign-up is hidden until Google OAuth is configured in Supabase.
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-50 px-4">
      <div className="w-full max-w-sm">
        ...
        {/* Google sign-up — hidden until Google OAuth is configured in Supabase.
            Flip SHOW_GOOGLE_LOGIN to true to re-enable. */}
        {SHOW_GOOGLE_LOGIN && (
          <>
